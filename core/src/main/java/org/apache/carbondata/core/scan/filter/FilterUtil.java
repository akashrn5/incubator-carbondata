...
public final class FilterUtil {
  ...
  private static BitSet getIncludeDictionaryValues(Expression expression, byte[][] dictionaryValues)
      throws FilterUnsupportedException {
  ...
  public static FilterExecuter getFilterExecutorForLocalDictionary(
    ...
    BitSet includeDictionaryValues = null;
    try {
    ...
    boolean isExclude = FilterUtil
        .isExcludeFilterNeedsToApply(includeDictionaryValues.cardinality(),
            rawColumnChunk.getLocalDictionary().length);
    byte[][] encodedFilterValues = FilterUtil
        .getEncodedFilterValues(includeDictionaryValues, rawColumnChunk.getLocalDictionary().length,
            isExclude);
