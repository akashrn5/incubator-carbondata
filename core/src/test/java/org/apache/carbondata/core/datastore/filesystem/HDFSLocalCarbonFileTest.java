...
public class HDFSLocalCarbonFileTest {

  private static final Logger LOGGER =
      LogServiceFactory.getLogService(HDFSLocalCarbonFileTest.class.getName());
  private static HDFSLocalCarbonFile hdfsLocalCarbonFile;
  ...
  static public void setUp() throws IOException {
    ...
    if (fs.exists(pt)) {
      ...
      hdfsLocalCarbonFile = new HDFSLocalCarbonFile(fileStatus);
  ...
  public void testRenameForceForException() throws IOException {
    ...
    hdfsLocalCarbonFile = new HDFSLocalCarbonFile(fileStatus);
    assertFalse(hdfsLocalCarbonFile.renameForce(fileName));
  }

  @Test
  public void testListFilesWithOutDirectoryPermission() {
    hdfsLocalCarbonFile = new HDFSLocalCarbonFile(fileStatusWithOutDirectoryPermission);
    ...
    assertArrayEquals(hdfsLocalCarbonFile.listFiles(), new CarbonFile[0]);
  }

  @Test
  public void testConstructorWithFilePath() {
    hdfsLocalCarbonFile = new HDFSLocalCarbonFile(fileName);
    assertTrue(hdfsLocalCarbonFile instanceof HDFSLocalCarbonFile);
  }
  ...
  public void testListFilesForNullListStatus() {
    ...
    hdfsLocalCarbonFile = new HDFSLocalCarbonFile(fileStatus);
    assertEquals(hdfsLocalCarbonFile.listFiles().length, 0);
  }
  ...
  public void testListDirectory() {
    ...
    assertEquals(hdfsLocalCarbonFile.listFiles().length, 1);
  }

  @Test
  public void testListFilesForException() throws IOException {
    new HDFSLocalCarbonFile(fileStatusWithOutDirectoryPermission);
  ...
  public void testListFilesWithCarbonFilter() {
    ...
    hdfsLocalCarbonFile = new HDFSLocalCarbonFile(fileStatus);
    assertEquals(hdfsLocalCarbonFile.listFiles(carbonFileFilter).length, 1);
  }
  ...
  public void testlistFilesWithoutFilter() {
    ...
    hdfsLocalCarbonFile = new HDFSLocalCarbonFile(fileStatus);
    assertEquals(hdfsLocalCarbonFile.listFiles(carbonFileFilter).length, 0);
  }
  ...
  public void testGetParentFileForNull() {
    ...
    hdfsLocalCarbonFile = new HDFSLocalCarbonFile(fileStatus);
    assertEquals(hdfsLocalCarbonFile.getParentFile(), null);
  }
  ...
  public void testGetParentFile() {
    ...
    hdfsLocalCarbonFile = new HDFSLocalCarbonFile(fileStatus);
    assertTrue(hdfsLocalCarbonFile.getParentFile() instanceof CarbonFile);
  }
  ...
  public void testForNonDisributedSystem() {
    ...
    assertEquals(new HDFSLocalCarbonFile(fileStatus).renameForce(fileName), true);
  }
  ...
  public void testrenameForceForDisributedSystem() {
    ...
    hdfsLocalCarbonFile = new HDFSLocalCarbonFile(fileStatus);
    assertEquals(hdfsLocalCarbonFile.renameForce(fileName), true);
